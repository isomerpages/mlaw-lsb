...
<ol class="a">
    ...
    <li class="alpha"><u>AUSTRALIA</u>
        <ul>
            ...
            <ul class="no-style">
                <li>A. Bachelor of Surveying (till 2011);</li>
                <li>B. Bachelor of Geomatic Engineering (Honours) (till 2012);</li>
                <li>C. Master of Engineering (Spatial) (from 2011) OR Master of Engineering (Geomatics) with any of the following:</li>
                <li>Bachelor of Science (Spatial System Major);</li>
                <li>Bachelor of Environments (Spatial Systems Major);</li>
                <li>Bachelor of Environments-Major in Geomatics (Geomatic Engineering).</li>
            </ul>
